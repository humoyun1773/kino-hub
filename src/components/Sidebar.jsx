    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              ...
              <span style={{ fontSize: '10px', display: 'block', color: '#64748b', marginTop: '-4px', fontWeight: 600 }}>
                KINO PLATFORMASI
              </span>
            </div>
          </div>
        ...
        <div style={{
          ...
          {/* Quick Random Movie Trigger in Sidebar */}
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', color: '#fb7185', fontWeight: 700, fontSize: '13px', marginBottom: '4px' }}>
              <Dices size={16} /> Kechqurun nima koʻrasiz?
            </div>
            <p style={{ fontSize: '11px', color: '#94a3b8', marginBottom: '10px' }}>
              Algoritm sizga eng mos tasodifiy filmni tanlab beradi.
            </p>
            <button
